...
#define WIND_DIRECTION 3.14						// Clock-wise from y axis, in �

#define CELL_SIDE 10							// m. Length of the cell (square) side. Cannot be chosen by user.
#define GRID_SIDE 1000							// m. Length of the grid size. Must be a multiple of CELL_SIDE. Can be chosen by user.
#define MAX_DISTANCE 10						    // m. Maximum distance between two vertices of the fire polygon.
